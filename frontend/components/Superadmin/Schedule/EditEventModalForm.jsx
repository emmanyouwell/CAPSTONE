...
import { addEvents, editEvents, getEventDetails } from "../../../redux/actions/eventActions";
const EditEventModalForm = ({ modalVisible, setModalVisible, eventID }) => {
    //   const [modalVisible, setModalVisible] = useState(false);
    const dispatch = useDispatch();
    const { userDetails, loading, error } = useSelector((state) => state.users);
    const { eventDetails, loading: editLoading, error: editError } = useSelector((state) => state.events);
                        ...
                        <View style={styles.modalView}>
                            <Formik
                                initialValues={{
                                    ...
                                    eventDetails: eventDetails ? eventDetails.eventDetails: new Date(),
                                    eventStatus: eventDetails ? eventDetails.eventStatus : "Not-Due",
                                ...
                                {({
                                    ...
                                    <View>
                                        ...
                                        <TextInput
                                            ...
                                            value={eventDetails ? format(new Date(eventDetails.eventDetails), 'MM/dd/yyyy @ HH:mm') : "MM/dd/yyyy @ HH:mm"}
