...
import { getArticleDetails, updateArticle } from '../../../redux/actions/articleActions';
import { resetError, resetUpdate } from '../../../redux/slices/articleSlice';
global.TextDecoder = TextDecoder;
global.TextEncoder = TextEncoder;
global.Buffer = Buffer;
const EditArticles = ({ navigation, route }) => {
    ...
    const { articleDetails, loading, error, isUpdated } = useSelector((state) => state.articles);
    useEffect(() => {
        startTransition(() => {
    ...
    useEffect(() => {
        dispatch(getArticleDetails(item._id))
    ...
    useEffect(() => {
        if (articleDetails) {
            ...
            setStoredArticle(articleDetails.description);
        }
    }, [articleDetails])
    useEffect(() => {
        if (error) {
    ...
    return (
        <View style={SuperAdmin.container}>
            ...
            <SafeAreaView style={styles.form}>
                <Text style={styles.screenTitle}>Edit Article</Text>
