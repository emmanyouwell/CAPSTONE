...
export const newPublicDonor = createAsyncThunk(
    ...
    async (req, thunkAPI) => {
        ...
        try {
            ...
            const response = await axios.post(`http://192.168.1.24:4000/api/v1/letting-newDonor`, req, config)
            return response.data;
...
export const getUpcomingLettings = createAsyncThunk(
    ...
    async (query, thunkAPI) => {
        ...
        try {
            ...
            const response = await axios.get(`http://192.168.1.24:4000/api/v1/upcoming/lettings`, config);
            return response.data;
...
export const getLettingDetails = createAsyncThunk(
    ...
    async (id, thunkAPI) => {
        ...
        try {
            ...
            const response = await axios.get(`http://192.168.1.24:4000/api/v1/letting/${id}`, config)
            return response.data;
...
export const deleteLetting = createAsyncThunk(
    ...
    async (id, thunkAPI) => {
        ...
        try {
            const response = await axios.delete(`http://192.168.1.24:4000/api/v1/letting/${id}`, config)
...
export const updateLetting = createAsyncThunk(
    ...
    async (req, thunkAPI) => {
        ...
        try {
            const response = await axios.put(`http://192.168.1.24:4000/api/v1/letting/${req.id}`, req, config)
